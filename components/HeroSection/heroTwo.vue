      ...
      <div class="row align-items-center h-100">
        ...
        <div class="col-12 col-md-7">
          <div class="welcome-intro">
            ...
            <p class="d-none d-md-block d-lg-block my-4">Futzo centraliza todas tus operaciones en una sola plataforma. Simplifica la administración y mejora la comunicación con tu
              equipo.</p>
        ...
        <div class="col-12 col-md-5">
          ...
          <div class="welcome-thumb" data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000">
            <img src="assets/img/image1 - monitor - dashboard.png" alt="Interfaz de gestión de equipos y jugadores en Futzo" width="445" height="425">
          </div>
        </div>
      </div>
    </div>
