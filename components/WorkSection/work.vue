      ...
      <div class="row">
        <div class="col-12 col-md-4">
          ...
          <div class="single-work text-center p-3">
            ...
            <div class="work-icon">
              <client-only>
                <nuxt-icon name="register" filled class="work-icon"></nuxt-icon>
              </client-only>
            </div>
        ...
        <div class="col-12 col-md-4">
          ...
          <div class="single-work text-center p-3">
            ...
            <div class="work-icon">
              <client-only>
                <nuxt-icon name="settings" filled class="work-icon"></nuxt-icon>
              </client-only>
            </div>
            <h3 class="text-white py-3">Inicia tu liga</h3>
            <p class="text-white">Empieza configurando tu liga: define sus reglas, horarios, y otros detalles importantes para que esté lista para el juego.</p>
          </div>
        </div>
        <div class="col-12 col-md-4">
          <!-- Single Work -->
          <div class="single-work text-center p-3">
            <!-- Work Icon -->
            <div class="work-icon">
              <img class="avatar-md" src="assets/img/work_thumb_3.png" alt="avatar">
            </div>
            <h3 class="text-white py-3">Configura y gestiona tu liga</h3>
            <p class="text-white">Agrega equipos y jugadores fácilmente. Asigna roles y organiza todos los aspectos de tu liga, todo desde un solo lugar, para que la administración
              sea más sencilla y eficiente.</p>
          </div>
        </div>
      </div>
    </div>
