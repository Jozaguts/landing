                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-7">
                        ...
                        <div class="section-heading text-center">
                            ...
                            <p class="d-none d-sm-block mt-4">Si tienes alguna pregunta sobre Futzo.io, consulta nuestras preguntas frecuentes. Hemos reunido las dudas más comunes para que puedas resolverlas rápidamente.</p>
                            <p class="d-block d-sm-none mt-4">Consulta nuestras preguntas frecuentes para resolver tus dudas sobre Futzo.io de manera rápida.</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                                    ...
                                    <div class="col-12 col-md-10 col-lg-8">
                                        ...
                                        <div class="card border-top-0 border-left-0 border-right-0 border-bottom">
                                            ...
                                            <div id="collapseTwo" class="collapse" data-parent="#sApp-accordion">
                                                <!-- Card Body -->
                                                <div class="card-body px-0 py-3">
                                                  No, Futzo.io es una plataforma basada en la web. Solo necesitas registrarte y acceder desde cualquier dispositivo con conexión a internet. No requiere instalación, lo que te permite empezar a usarla de inmediato.
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Single Accordion Item -->
                                        <div class="card border-top-0 border-left-0 border-right-0 border-bottom">
                                            ...
                                            <div id="collapseThree" class="collapse" data-parent="#sApp-accordion">
                                                <!-- Card Body -->
                                                <div class="card-body px-0 py-3">
                                                  Sí, Futzo.io te permite organizar y administrar múltiples torneos simultáneamente. La plataforma está diseñada para manejar la complejidad de gestionar varios torneos sin perder de vista los detalles importantes.
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Single Accordion Item -->
                                        <div class="card border-top-0 border-left-0 border-right-0 border-bottom">
                                            ...
                                            <div id="collapseFour" class="collapse" data-parent="#sApp-accordion">
                                                <!-- Card Body -->
                                                <div class="card-body px-0 py-3">
                                                  Futzo.io ofrece soporte técnico 24/7 para todos sus usuarios. Nuestro equipo está disponible para ayudarte con cualquier problema técnico o consulta que puedas tener, asegurando que siempre tengas acceso a la asistencia que necesitas.
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Single Accordion Item -->
                                        <div class="card border-top-0 border-left-0 border-right-0 border-bottom">
                                            ...
                                            <div id="collapseFive" class="collapse" data-parent="#sApp-accordion">
                                                <!-- Card Body -->
                                                <div class="card-body px-0 py-3">
                                                  Absolutamente. Futzo.io utiliza tecnologías de encriptación avanzadas y copias de seguridad diarias para garantizar que todos tus datos estén seguros y protegidos. La privacidad y seguridad de tu información son nuestras prioridades.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
